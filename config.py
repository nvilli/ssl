...
__C.MODEL_LIST = ['c3d', 'r3d', 'r21d']                                 # TODO: set model list
__C.SAVE_PATH = '/data/guojie'                                          # TODO: set workspace path
__C.GPUS = 8                                                            # TODO: set the count of used GPU
__C.GPU_ID = '0,1,2,3,4,5,6,7,8'                                        # TODO: set available gpus id
...
__C.TRAIN.START_EPOCH = 1                                               # TODO: set the start epoch
...
__C.DATASET.CLASS_NUM = 101                                             # TODO: set the number of class
__C.DATASET.VAL_SIZE = 800                                              # TODO: set the size of validation dataset
